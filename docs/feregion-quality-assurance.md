...
The b1 direct ObsPy environment was invalid, and corrected-reference execution,
controlled remaining failure states, predecessor reconciliation, and static-site replay
remain required before ASV migration completion. These open items do not undo
